  ...
  return (
    <div className="grid gap-8 lg:grid-cols-3" data-testid="payment-options">
      ...
      <article className="flex flex-col rounded-2xl border border-navy-100 bg-white p-7 shadow-sm">
        ...
        <p className="mt-3 leading-7 text-navy-600">
          In PayPal, choose Send Money and enter the confirmed recipient email
          below.
        </p>
        <div className="mt-6 flex items-center justify-between gap-3 rounded-xl bg-cream p-4">
          <span className="break-all font-semibold text-navy">
            {PAYPAL_EMAIL}
          </span>
          <CopyValue value={PAYPAL_EMAIL} label="PayPal email" />
        </div>
        <p className="mt-5 text-sm leading-6 text-navy-500">
          Check that the recipient is Salim Cyrus before confirming. PayPal fees
          and currency conversion may apply.
        </p>
        <Button
