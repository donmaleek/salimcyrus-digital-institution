...
export const coachingOffers: CoachingOffer[] = [
  {
    ...
    paystackUrl: 'https://paystack.com/buy/30-mins-personal-clarity-and-direction-session-qsrjip',
  },
  {
    ...
    paystackUrl: 'https://paystack.com/buy/1-hour-personal-coaching-session-mfkrkq',
  },
  {
...
export const coachingProcess = ['Diagnose', 'Decide', 'Build', 'Execute', 'Review']
...
export const coachingFaqs = [
  { q: 'How quickly can I expect to see movement?', a: 'Most clients leave the first session with one clear, defensible next step — momentum compounds from there.' },
  { q: 'What happens between sessions?', a: 'Midweek check-in support keeps follow-through visible without needless meetings.' },
  { q: 'Do you offer support outside the scheduled time?', a: 'Accountability check-ins are answered within a 24-hour window.' },
  { q: 'What if I need to pause the work?', a: 'We pause rather than progress when you need more time to choose — the work only moves at your decision.' },
  { q: 'How do you keep the engagement private?', a: 'All coaching is conducted one-on-one and treated as confidential.' },
]
