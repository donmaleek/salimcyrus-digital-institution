...
export const programs: Program[] = [
  {
    ...
    description:
      'Flagship transformation track that replaces false identities with purpose and disciplined execution.',
    highlights: [
  ...
  },
  {
    ...
    description:
      'Build a community of thinkers who can apply revelation to real life decisions.',
    highlights: [
  ...
  },
  {
    ...
    description:
      'A direct challenge to rebuild strength, accountability, and leadership in men.',
    highlights: [
      'Sexual discipline and self-mastery',
      'Leadership in relationships',
    ],
    scripture:
      '1 Corinthians 16:13 (AMP): act like men, be courageous, be strong.',
    priceKes: 25000,
    priceUsd: 193,
    closingLine:
      'This will challenge men where society has made them comfortable.',
  ...
  },
  {
    ...
    description:
      'Build relational clarity with tools that replace confusion with maturity.',
    highlights: [
  ...
  },
  {
    ...
    description:
      'Turn revelation into consistent action with daily structure and accountability.',
    highlights: [
  ...
  },
  {
    ...
    description:
      'A private container for leaders who want direct access and live case analysis.',
    highlights: ['Weekly private sessions', 'Direct Q and A access'],
    priceKes: 20000,
    priceUsd: 155,
    recurring: true,
    closingLine:
      'This is where you stop speaking to crowds and start raising leaders.',
  ...
  },
  {
    ...
    description:
      'Walk through healing with a clear process that restores trust and self-worth.',
    highlights: [
      'Forgiveness as a decision, not a feeling',
      'Breaking soul ties',
    ],
    scripture:
      'Psalm 147:3 (AMP): He heals the brokenhearted and binds their wounds.',
    priceKes: 15000,
    priceUsd: 116,
