...
const checks = [
  ...
  ['landscape page heroes reserve a large desktop column', pageHero.includes('minmax(440px,640px)')],
  ['page heroes have expanded desktop spacing', pageHero.includes('lg:py-32')],
